    ...
    return (
        ...
        >
            ...
            <div className="col-2 col-md-2 pt-md-3">
                <button className={`btn btn-sm md-1 ${props.contact.isFavorite ? "btn-warning" : "btn-outline-warning"}`}
                    onClick={() => props.favouriteClick(props.contact)}
                // if not converted to arrow function the method will be invoked immediately
                >
